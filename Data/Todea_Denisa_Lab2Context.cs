...
namespace Todea_Denisa_Lab2.Data
{
    public class Todea_Denisa_Lab2Context : DbContext
    {
        ...
        public DbSet<Todea_Denisa_Lab2.Models.Publisher> Publisher { get; set; }

        public DbSet<Todea_Denisa_Lab2.Models.Author> Authors { get; set; }

        public DbSet<Todea_Denisa_Lab2.Models.Category> Category { get; set; }

        public DbSet<Todea_Denisa_Lab2.Models.Member> Member { get; set; }

        public DbSet<Todea_Denisa_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
